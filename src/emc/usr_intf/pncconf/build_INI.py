...
class INI:
    ...
    def write_inifile(self, base):
        ...
        print(file=file)
        print("[HOSTMOT2]", file=file)
        print("# **** This is for info only ****", file=file)
        print("# DRIVER0=%s"% self.d.mesa0_currentfirmwaredata[_PD._HALDRIVER], file=file)
        print("# BOARD0=%s"% self.d.mesa0_currentfirmwaredata[_PD._BOARDNAME], file=file)
        if self.d.number_mesa == 2:
            print("# DRIVER1=%s" % self.d.mesa1_currentfirmwaredata[_PD._HALDRIVER], file=file)
            print("# BOARD1=%s"% self.d.mesa1_currentfirmwaredata[_PD._BOARDNAME], file=file)
    ...
    def write_one_joint(self, file, num, letter, type, all_homes, tandemflag):
        ...
        print(file=file)
        if letter == 's':
            print("[SPINDLE_%d]" % num, file=file)
        else:
